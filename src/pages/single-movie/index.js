...
const SingleMovie = () => {
  ...
  <h2 className="custom-section-title text-3xl font-bold text-center">All Casts</h2>
  <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 md:grid-cols-4">
    {singleMovieCredits.cast.slice(0, 16).map((singleCast) => {
      return (
        <div key={singleCast.id} className="space-y-2 group">
          <div className="max-h-[320px] overflow-hidden rounded-md shadow-lg transition-transform transform group-hover:scale-105">
            {singleCast.profile_path ? (
              ...
              <div className="h-[320px] rounded-md bg-gray-100 flex items-center justify-center">
                <span className="text-gray-500">No Image</span>
              </div>
            )}
          </div>
          <h2 className="text-lg font-semibold text-center group-hover:text-accent">{singleCast.original_name}</h2>
          <p className="text-sm text-center text-gray-600">{singleCast.character}</p>
        </div>
      );
    })}
  </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-2">
                <h2 className="custom-minor-title">Imdb Rating</h2>
              ...
              <div className="space-y-2">
                ...
                <p>{singleMovie.revenue} Dollar</p>
              </div>
              <div className="space-y-2">
